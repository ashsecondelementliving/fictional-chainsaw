...
#            return match.group(1) if match else ""
    ...
    def createBody(message):
        ...
        if len(messageArr) > 1:
            ...
            canned_koorosh = [
                "I am the founder here at Second Element Living. We partner with executives and senior leaders navigating career advancement or transitioning into new roles.",
                ...
                "Would love to discuss your career aspirations and see if we can help.\nLet me know if you are interested.",
                f"Best,\n{senderName}"
            ]

            canned_enrollers = [
                "I am an executive mentor here at Second Element Living. We partner with executives and senior leaders navigating career advancement or transitioning into new roles.",
                "Your background is similar to those of our top successful clients who have landed senior level positions. Many of their testimonials are on my LinkedIn profile page and our web site.",
                "Would love to discuss your career aspirations and see if we can help.\nLet me know if you are interested.",
                f"Best,\n{senderName}"
            ]
            ...
            if "koorosh" in sender_lower:
                canned = canned_koorosh
              
            elif "kathy" in sender_lower:
                canned = canned_enrollers
              
            elif "ash" in sender_lower:
                canned = canned_setters
            elif "shawn" in sender_lower:
                canned = canned_setters
              
            elif "maria" in sender_lower:
                canned = canned_setters
            elif "joanna" in sender_lower:
                canned = canned_setters
            elif "manette" in sender_lower:
                canned = canned_setters
            elif "pearlyn" in sender_lower:
                canned = canned_setters
            elif "jobelle" in sender_lower:
                canned = canned_setters
            elif "ariza" in sender_lower:
                canned = canned_setters
            elif "joshua" in sender_lower:
                canned = canned_setters

            else:
                canned = canned_default
