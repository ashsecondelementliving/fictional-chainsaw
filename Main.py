...
def mainpy (senderName, input_file):
...
Ideal example based on provided input data:
    ...
    def createBody(message):
        ...
        if len(messageArr) > 1:
            ...
            messageArr.append(canned_message_1)
            messageArr.append(canned_message_2)
            messageArr.append(canned_message_3)
            messageArr.append(canned_message_4)
            messageArr.append(canned_message_5)
            return messageArr
        else:
            messageErr = [""]
            return messageErr
